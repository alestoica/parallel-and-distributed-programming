...
public class SequentialRanking {
    public static void main(String[] args) throws IOException {
            ...
            for (int i = 1; i <= 10; i++) {
                ...
                try (BufferedReader br = new BufferedReader(new FileReader(filename))) {
                    ...
                    while ((line = br.readLine()) != null) {
                        ...
                        if (score == -1) {
                            blacklist.add(id);
                            ranking.addOrUpdate(id, score, country);
                        } else {
                            ranking.addOrUpdate(id, score, country);
                        }
                    }
        ...
        System.out.println("Blacklist: " + String.join(", ", blacklist.stream().sorted()
                .map(String::valueOf)
                .toArray(String[]::new)));
        System.out.println();
        System.out.println("Blacklist length: " + blacklist.size());
