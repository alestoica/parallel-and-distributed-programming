...
//                    break;
    ...
    public static void main(String[] args) {
        String file1 = "output/ranking_sequential.txt";
        String file2 = "output/ranking_parallel.txt";

        SortPairsFromFile.main(file1);
        SortPairsFromFile.main(file2);
        assertResults(file1, file2);
    }
}
