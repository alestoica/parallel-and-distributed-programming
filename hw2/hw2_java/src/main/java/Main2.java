...
class Main2 {
    private static int N, M, n, m, p, lineOffset=1, columnOffset=1;
    ...
    public static void main(String[] args) throws InterruptedException {
        read("C:\\Users\\andre\\Documents\\facultate\\an3\\ppd\\lab2\\incercarea101_sap4\\src\\input3.txt");
        p = Integer.parseInt(args[0]);
//        p = 4;
//        lineOffset = (n - 1) / 2;//1
//        columnOffset = (m - 1) / 2;//1
//        lineOffset = 2;
//        columnOffset = 2;
        ...
        write("C:\\Users\\andre\\Documents\\facultate\\an3\\ppd\\lab2\\incercarea101_sap4\\src\\output.txt", matrix);
    }

    public static void addBorders(int lineOffset, int columnOffset) {
        int[][] aux = new int[N + 2 * lineOffset][M + 2 * columnOffset];//[12][12]
...
//                System.out.println(" Calculul "+(  y - columnOffset + j));
    ...
    public static void parallelConvolution() throws InterruptedException {
        ...
        int start, end = lineOffset;
        int chunk = N / p;//10/4= 2
        int rest = N % p;//=2
        ...
        for (int i = 0; i < t.length; i++) {
            ...
            t[i] = new Worker(M, start, end, finalMatrix);// 0 -> 3
            t[i].start();
        }
